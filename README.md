...
- 🔁 Tab **Ôn tập** dùng **lịch lặp ngắt quãng (spaced repetition, thuật toán SM-2)**, với 2 kiểu luyện tập chung 1 lịch ôn:
  - 🗂️ **Thẻ ghi nhớ**: lật thẻ rồi chấm điểm 4 mức **Quên / Khó / Tốt / Dễ** — mỗi nút hiện sẵn khoảng cách đến lần ôn tiếp theo.
  - 🎯 **Trắc nghiệm**: chọn 1 trong 4 đáp án (3 đáp án nhiễu lấy từ cùng chủ đề), phản hồi đúng/sai ngay, tự động chấm vào lịch ôn như thẻ ghi nhớ.
  Mỗi thẻ có lịch ôn riêng (độ khó, khoảng cách ngày, ngày đến hạn) lưu theo từng ngôn ngữ; thẻ nhớ tốt giãn cách ra vài ngày/tuần/tháng, thẻ hay quên quay lại ngay hôm sau. Màn hình thiết lập hiện sẵn số thẻ đến hạn hôm nay + số thẻ mới theo chủ đề đã chọn.
- 📊 **Dashboard tiến trình** (bấm huy hiệu 🔥 ở header): số ngày học liên tục (streak), biểu đồ hoạt động 7 ngày gần nhất, số thẻ đến hạn ôn hôm nay, và % từ/câu đã thuộc theo từng ngôn ngữ trong số 4 ngôn ngữ.
